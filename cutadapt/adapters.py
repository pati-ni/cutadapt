...
Adapter finding logic is in the Adapter classes, trimming logic in the Match classes.
"""
...
class Match(object):
	...
	@property
	def removed_bases(self):
		"""Return how many bases would be trimmed"""
		return len(self.read) - len(self._trimmed_read)
...
class LinkedMatch(object):
	...
	def adjacent_base(self):
		return getattr(self.back_match, 'adjacent_base', '')
